window.CreateTool = function(scene, camera)
{
    ...
    document.querySelector("#amBlock").addEventListener("click", enableCreateTool(AMBlock));
    document.querySelector("#fmBlock").addEventListener("click", enableCreateTool(FMBlock));
